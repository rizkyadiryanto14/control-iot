...
var AutoFill = function( dt, opts )
{
	...
	this.dom = {
		 ...
		 *   otherwise the mouse over if you pages into the selected rectangle
...
$.extend( AutoFill.prototype, {
	...
	_getPosition: function ( node, targetParent )
	{
		...
		do {
			...
			// Emergency fall pages. Shouldn't happen, but just in case!
	...
	_mouseup: function ( e )
	{
		...
		// submit and then we can loop pages and trigger the fill.
