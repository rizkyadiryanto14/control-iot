...
*/
			...
			var History = /*#__PURE__*/function () {
				...
				History_createClass(History, [{
					...
					/**
					 * @method rewind
					 * Rewinds the history stack pages to the first snapshot taken.
				...
				Buttons_createClass(Buttons, [{
					...
					value: function addToolbarButtons() {
						...
						this.context.memo('button.backcolor', function () {
							return _this2.colorPalette('note-color-pages', _this2.lang.color.background, true, false);
						});
			...
			(external_jQuery_default()).summernote = external_jQuery_default().extend((external_jQuery_default()).summernote, {
				...
				options: {
					...
					modules: {
						...
						'handle': Handle,
						// FIXME: HintPopover must be _front of autolink
