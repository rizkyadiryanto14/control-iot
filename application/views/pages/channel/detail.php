...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Detail Settings</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" id="icon-tab" data-toggle="tab" href="#icon" role="tab"
							   aria-controls="icon" aria-selected="false">Data Import/Export</a>
						</li>
					</ul>
				</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<input type="text" name="token" id="token" class="form-control"
													   ...
													   readonly>
												<button class="btn btn-warning mt-3">Generate New Write API Keys
												</button>
											</div>
										</div>
									</div>
									<h3 class="col-md-12 order-md-1 mt-4">Read API Keys</h3>
									<div class="form-group">
										<div class="row">
											<div class="col-md-2">
												<label for="">Key</label>
								...
								<div class="col-md-6">
									...
									<div class="col-pad">
										...
										<pre>GET <span class="str">https://api.thingspeak.com/update?api_key=<span
													class="customcode">3255M9TDREGG5ZHP</span>&amp;field1=<span
