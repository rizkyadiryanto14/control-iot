...
<head>
	...
	<link href="<?= base_url() ?>back_assets/home/css/styles.css" rel="stylesheet"/>
</head>
			...
			<div class="row gx-5 align-items-center">
				<div class="col-xxl-5">
					...
					<div class="text-center text-xxl-start">
						...
						<div class="fs-3 fw-light text-muted">I can help your problem</div>
						<h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Get online and grow fast You'r IoT Platform</span>
						</h1>
				...
				<div class="col-xxl-7">
					...
					<div class="d-flex justify-content-center mt-5 mt-xxl-0">
						<div class="profile bg-gradient-primary-to-secondary">
							...
							<img class="profile-img" src="<?= base_url() ?>back_assets/img/mobile.png"
								 alt="..."/>
							<div class="dots-1">
								<!-- SVG Dots-->
...
<!-- Core theme JS-->
<script src="<?= base_url() ?>back_assets/home/js/scripts.js"></script>
</body>
</html>
