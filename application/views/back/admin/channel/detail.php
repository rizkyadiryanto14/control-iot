                            ...
                            <form action="#" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 order-md-1">
                                        ...
                                        <span>Channels store all the data that a ThingSpeak application collects. Each
                                            channel includes eight fields that can hold any type of data, plus three
                                            fields for location data and one for status data. Once you collect data in a
                                            channel, you can use ThingSpeak apps to analyze and visualize it.</span>
...
<!--                                                </form>-->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-pad">
                                        ...
                                        <a href="#">Read a Channel Feed <small class="badge badge-danger">
                                                Beta</small></a>
                                        <pre>GET <span class="str">https://api.thingspeak.com/update?api_key=<span
													...
													class="customcode">0</span></span></pre>
                                        <a href="#">Read a Channel Field <small class="badge badge-danger">
                                                Beta</small></a>
                                        <pre>GET <span class="str">https://api.thingspeak.com/update?api_key=<span
													class="customcode"><?php echo empty($token['token']) ? '' : $token['token']; ?>></span>&amp;field1=<span
													class="customcode">0</span></span></pre>
